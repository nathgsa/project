      ...
      {links.map((link) => {
        ...
        return (
          <Link
            ...
            className={clsx(
              'flex h-[48px] grow gap-2 items-center rounded-md bg-gray-50 p-3 text-sm font-medium hover:bg-sky-100 hover:text-blue-600 md:flex-none md:justify-start md:p-2 md:px-3',
              {
